...
<head>
    ...
    <title>Factura de Venta - Creditos Alicia</title>
    <style>
    ...
    <div class="container">
        ...
        <div class="info">
            <div class="client-info">
                ...
                <p><strong>CI/NIT:</strong> 1234567</p>
            ...
            <div class="invoice-info">
                ...
                <p><strong>Factura N°:</strong> 001-002-000123</p>
                <p><strong>Fecha:</strong> 27/06/2024</p>
                <p><strong>Forma de Pago:</strong> Contado</p>
                <p><strong>Vendedor:</strong> Carlos Rodríguez</p>
            </div>
        </div>
        <table>
            <thead>
        ...
        <div class="total">
            <p>Total a Pagar: Bs 45,000.00</p>
        </div>
        <div class="footer">
