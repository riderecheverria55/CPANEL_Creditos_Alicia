                                          ...
                                          <tr>
                                            ...
                                            <td class="text-center">     
                                              <center>
                                                ...
                                                data-target="#editModal{{$item->COD_SUCURSAL }}"><i class="fa fa-pencil" aria-hidden="true"></i>
                                                </button>
                                                <button class="btn btn-danger btn-sm mx-2 eliminarSucursal" action="{{ url('sucursales/destroy',$item->COD_SUCURSAL) }}"
                                                  method="DELETE" token="{{ csrf_token() }}" pagina="sucursales">
                                            ...
                                            <div class="modal fade" id="editModal{{$item->COD_SUCURSAL}}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div id="editDivision">
                                                                <form action="{{url('sucursales/update', $item->COD_SUCURSAL)}}" method="POST">
                                                                    ...
                                                                    <input type="text" id="editCampo5" value="{{$item->NOMBRE_SURCUSAL}}" required name="nombre"><br>

                                                                    <label for="editCampo7">Direccion:</label>
                                                                    <input type="text" id="editCampo7" value="{{$item->DIRECCION}}" required name="direccion"><br>
                                                                    ...
                                                                    <select name="cod_empleado" class="form-control selectric select2" id="select2">
                                                                        ...
                                                                        @if($empleados->COD_EMPLEADO==$item->EMPLEADO_COD)
                                                                          <option value="{{$empleados->COD_EMPLEADO}}" selected>{{$empleados->NOMBRE}} {{$empleados->APELLIDO}}</option>
                                                                        @else
