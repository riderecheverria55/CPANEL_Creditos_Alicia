            ...
            <div class="modal-body">
                ...
                <div id="editDivision">
                    <form id="editInfoContactoForm">
                        ...
                        <input type="text" id="editCampo5" name="editCampo5"><br>

                        <label for="editCampo7">Ubicación:</label>
                        <input type="text" id="editCampo7" name="editCampo7"><br>

                        <label for="editCampo8">Seleccionar encargado:</label>
                        <select>
                            <option>Encargado José Fredy</option>
                            <option>Encargado José Carlos</option>
                            <option>Encargado José Manuel</option>
                        </select>
                    </form>
                </div>
                <div class="derecha">
                ...
                <div class="modal-body">
                    ...
                    <div id="division3">
                        <form id="infoContactoForm">
                            ...
                            <label for="campo7">Ubicación:</label>
